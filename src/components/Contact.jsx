const links = [
  ...
  { href: 'tel:+916382182427', label: '+91 63821 82427' },
  { href: 'https://github.com/Ajaysvasan', label: 'GitHub', external: true },
  { href: 'https://linkedin.com/in/ajay-s-vasan-584111291', label: 'LinkedIn', external: true },
]

export default function Contact() {
  return (
    <section id="contact" className="py-24 sm:py-32 scroll-mt-20 bg-anime-surface/30">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-anime-text mb-4 font-anime">
          Get in touch
        </h2>
        <p className="text-anime-text-dim mb-10">Have a project in mind or want to connect?</p>
